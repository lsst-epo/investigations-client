...
module.exports = {
  ...
  plugins: ["jsx-a11y", "react", "react-hooks", "unused-imports", "@typescript-eslint"],
  extends: ["standard", "next", "prettier", "plugin:jsx-a11y/recommended", "plugin:react/recommended", "plugin:prettier/recommended", "plugin:import/errors", "plugin:@typescript-eslint/recommended", "plugin:storybook/recommended"]
};